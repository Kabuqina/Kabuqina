...
const HTML_DIR = path.join(ROOT, "soft-editorial_html");
...
const BUILD_ROOT = path.resolve("outputs/manual-20260608-soft-editorial/presentations/html-background-master");
...
function normalizeFont(fontFamily) {
  ...
  if (value.includes("Work Sans")) return "Work Sans";
  return "Work Sans";
}
...
async function writeSlideModules(slides) {
  ...
  await ctx.addImage(slide, {
    ...
    fit: "cover",
    alt: "Soft Editorial HTML-rendered background ${slideNo}",
