...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            study::cmd_study_knowledge_core_compilation_create,
            study::cmd_study_knowledge_core_compilation_list,
            study::cmd_study_knowledge_core_compilation_get,
            study::cmd_study_knowledge_core_compilation_retry,
            study::cmd_study_knowledge_core_compilation_cancel,
