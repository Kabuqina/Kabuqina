...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "(possibly OpenClaw or another Kabuqina instance). "
            "Kabuqina stopped Telegram polling after %d retries. "
            "Only one poller can run per token — stop the other process "
            "and restart with 'kabuqina start'."
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                from kabuqina_cli.commands import telegram_menu_commands
