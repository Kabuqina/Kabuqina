...
Config: ~/.kabuqina/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.kabuqina/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_kabuqina_home()`` helper (HERMES_HOME-aware and
...
RULES_FILE = get_kabuqina_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_kabuqina_home() / "feishu_comment_pairing.json"
