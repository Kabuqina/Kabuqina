...
"""'What is missing from the config / .env / skills' detection for kabuqina_cli.

Extracted from ``kabuqina_cli/config.py``: the checklist helpers used by setup /
...
from kabuqina_cli.config_env_schema import OPTIONAL_ENV_VARS, REQUIRED_ENV_VARS
from kabuqina_cli.config_env import get_env_value
