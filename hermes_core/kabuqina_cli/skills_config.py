"""
Skills configuration for Kabuqina.
`kabuqina skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.kabuqina/config.yaml under:
...
from kabuqina_cli.config import cfg_get, load_config, save_config
...
def skills_command(args=None):
    """Entry point for `kabuqina skills`."""
    from kabuqina_cli.curses_ui import curses_checklist
