...
from providers.nous_auth import get_nous_auth_status
from kabuqina_cli.config import get_env_value, load_config
...
def get_nous_subscription_features(
    ...
    # Tool Gateway via `kabuqina model`, so direct credentials should NOT
