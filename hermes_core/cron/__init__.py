"""
Cron job scheduling system for Kabuqina.
...
Cron jobs are executed automatically by the gateway daemon:
    kabuqina gateway install    # Install as a user service
    sudo kabuqina gateway install --system  # Linux servers: boot-time system service
    kabuqina gateway            # Or run in foreground
