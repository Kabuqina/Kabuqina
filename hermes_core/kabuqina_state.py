#!/usr/bin/env python3
"""
SQLite state store for Kabuqina's owned agent core.
...
DEFAULT_DB_PATH = get_kabuqina_home() / "state.db"
...
class SessionDB:
    ...
    # With multiple Kabuqina processes (gateway + CLI sessions + worktree agents)
