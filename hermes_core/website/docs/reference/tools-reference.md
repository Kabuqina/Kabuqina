...
The registry includes browser automation, file and document tools, RL training, Home Assistant control, terminal/process tools, web retrieval, messaging, and platform-specific additions.
