...
<tr><td><b>Lives where you do</b></td><td>Weixin, QQBot, DingTalk, Telegram, WhatsApp, Email, and the desktop shell — with profile-scoped gateway processes and cross-platform conversation continuity.</td></tr>
...
| [Messaging Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging) | Mainland: Weixin, QQBot, DingTalk; SEA: Telegram, WhatsApp, Email |
