"""ACP permission bridging — maps ACP requests to Kabuqina approval callbacks."""
...
# Maps ACP PermissionOptionKind -> Kabuqina approval result strings
_KIND_TO_KABUQINA = {
    "allow_once": "once",
    "allow_always": "always",
    "reject_once": "deny",
...
def make_approval_callback(
    ...
    """
    Return a Kabuqina-compatible ``approval_callback(command, description) -> str``
        ...
        if isinstance(outcome, AllowedOutcome):
            ...
            for opt in options:
                if opt.option_id == option_id:
                    return _KIND_TO_KABUQINA.get(opt.kind, "deny")
