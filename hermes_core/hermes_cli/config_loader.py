...
"""The config loader core: read/merge/expand/save ``config.yaml`` for hermes_cli.

Extracted from ``hermes_cli/config.py`` — the top of the config dependency stack:
...
extracted leaves (defaults/merge/home/paths/managed). ``hermes_cli.config``
...
from hermes_cli.config_merge import (
    _deep_merge,
    _expand_env_vars,
...
from hermes_cli.config_paths import get_config_path
