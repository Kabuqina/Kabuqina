...
"""Config structure validation + version check for hermes_cli.

Extracted from ``hermes_cli/config.py``: the config schema-version check, the
...
defaults siblings. ``hermes_cli.config`` re-exports every name.
"""
