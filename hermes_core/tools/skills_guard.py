...
Trust levels:
  - builtin:   Ships with Kabuqina. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.(?:kabuqina|hermes)/\.env|\~/\.(?:kabuqina|hermes)/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Kabuqina secrets file"),
    ...
    (r'\.(?:kabuqina|hermes)/config\.yaml|\.(?:kabuqina|hermes)/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Kabuqina configuration files directly"),
