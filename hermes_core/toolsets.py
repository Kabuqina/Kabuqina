...
TOOLSETS = {
    ...
    "file": {
        "description": "File manipulation tools: read, write, patch, search, and bounded metadata hashing",
        "tools": ["read_file", "write_file", "patch", "search_files", "file_metadata"],
        "includes": []
    },
    ...
    "documents": {
        ...
        "tools": ["document_read_precise", "pdf_read_precise", "material_index_build", "pdf_write", "html_write", "docx_write", "pptx_write"],
        "includes": []
    },
