...
@patch("providers.model_metadata.get_model_context_length", return_value=80_000)
@patch("providers.chat_completions.get_text_auxiliary_client")
...
@patch("providers.model_metadata.get_model_context_length", return_value=32_768)
@patch("providers.chat_completions.get_text_auxiliary_client")
...
@patch("providers.model_metadata.get_model_context_length", return_value=200_000)
@patch("providers.chat_completions.get_text_auxiliary_client")
...
@patch("providers.model_metadata.get_model_context_length", return_value=1_000_000)
@patch("providers.chat_completions.get_text_auxiliary_client")
...
@patch("providers.model_metadata.get_model_context_length", return_value=128_000)
@patch("providers.chat_completions.get_text_auxiliary_client")
...
def test_init_feasibility_check_uses_aux_context_override_from_config():
    ...
    with (
        patch("kabuqina_cli.config.load_config", return_value=cfg),
        patch("run_agent.get_tool_definitions", return_value=[]),
        patch("run_agent.check_toolset_requirements", return_value={}),
        patch("run_agent.OpenAI"),
        patch("run_agent.ContextCompressor", new=_StubCompressor),
        patch("providers.chat_completions.get_text_auxiliary_client", return_value=(mock_client, "custom/big-model")),
        patch("providers.model_metadata.get_model_context_length", return_value=1_000_000) as mock_ctx_len,
    ):
        agent = AIAgent(
...
@patch("providers.model_metadata.get_model_context_length", return_value=100_000)
@patch("providers.chat_completions.get_text_auxiliary_client")
...
@patch("providers.model_metadata.get_model_context_length", return_value=99_999)
@patch("providers.chat_completions.get_text_auxiliary_client")
