"""Tests for kabuqina_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSchemaInit:
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from kabuqina_state import SCHEMA_SQL
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import sqlite3
        import inspect
        from kabuqina_state import SessionDB as _SessionDB
