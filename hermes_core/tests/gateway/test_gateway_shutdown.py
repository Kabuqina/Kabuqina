...
def test_cleanup_agent_resources_reaps_stale_aux_clients():
    ...
    with patch("providers.chat_completions.cleanup_stale_async_clients") as cleanup_mock:
...
async def test_gateway_stop_interrupts_running_agents_and_cancels_adapter_tasks():
    ...
    with (
        ...
        patch("providers.chat_completions.shutdown_cached_clients") as shutdown_cached_clients,
    ):
        await runner.stop()
