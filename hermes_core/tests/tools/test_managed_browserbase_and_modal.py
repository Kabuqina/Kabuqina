...
def _enable_managed_nous_tools(monkeypatch):
    ...
    kabuqina_cli.auth and kabuqina_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("kabuqina_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("kabuqina_cli.models.check_nous_free_tier", lambda: False)
...
def _install_fake_tools_package():
    ...
    sys.modules["providers.chat_completions"] = types.SimpleNamespace(
