...
class TestBrowserConsoleToolsetWiring:
    ...
    def test_in_hermes_core_tools(self):
        ...
        assert "browser_console" in _KABUQINA_CORE_TOOLS
...
class TestBrowserVisionConfig:
    ...
    def test_browser_vision_uses_configured_temperature_and_timeout(self, tmp_path):
        ...
        with (
            patch("kabuqina_constants.get_kabuqina_dir", return_value=shots_dir),
            ...
            patch("tools.browser_tool._get_vision_model", return_value="test-model"),
            patch("kabuqina_cli.config.load_config", return_value={"auxiliary": {"vision": {"temperature": 1, "timeout": 45}}}),
