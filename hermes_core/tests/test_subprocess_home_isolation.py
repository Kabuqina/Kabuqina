...
class TestGetSubprocessHome:
    """Unit tests for kabuqina_constants.get_subprocess_home()."""

    def test_returns_none_when_kabuqina_home_unset(self, monkeypatch):
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("KABUQINA_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("KABUQINA_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_no_injection_when_kabuqina_home_unset(self, monkeypatch):
        monkeypatch.delenv("KABUQINA_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from kabuqina_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from kabuqina_cli.profiles import create_profile
