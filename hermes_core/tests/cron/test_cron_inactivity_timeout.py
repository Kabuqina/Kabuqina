...
class TestSysPathOrdering:
    ...
    def test_kabuqina_time_importable(self):
        """kabuqina_time should be importable when cron.scheduler loads."""
        # This import would fail if sys.path.insert comes after the import
        from cron.scheduler import _kabuqina_now
        assert callable(_kabuqina_now)

    def test_kabuqina_constants_importable(self):
        """kabuqina_constants should be importable from cron context."""
        from kabuqina_constants import get_kabuqina_home
        assert callable(get_kabuqina_home)
