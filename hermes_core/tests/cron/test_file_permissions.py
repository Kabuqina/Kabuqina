...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("kabuqina_cli.config_loader.get_config_path", return_value=config_path), \
             patch("kabuqina_cli.config_loader.ensure_kabuqina_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("kabuqina_cli.config_env.get_env_path", return_value=env_path), \
             patch("kabuqina_cli.config_env.ensure_kabuqina_home"):
    ...
    def test_ensure_kabuqina_home_sets_0700(self):
        home = Path(self.tmpdir) / ".hermes"
        with patch("kabuqina_cli.config_home.get_kabuqina_home", return_value=home):
