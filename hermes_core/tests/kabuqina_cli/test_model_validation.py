"""Tests for provider-aware `/model` validation in kabuqina_cli.models."""
...
def _validate(model, provider="openrouter", api_models=FAKE_API_MODELS, **kw):
    ...
    with patch("kabuqina_cli.models.fetch_api_models", return_value=api_models), \
         patch("kabuqina_cli.models.probe_api_models", return_value=probe_payload):
...
class TestProviderModelIds:
    ...
    def test_stepfun_prefers_live_catalog(self):
        with patch(
            "kabuqina_cli.auth.resolve_api_key_provider_credentials",
            return_value={"api_key": "***", "base_url": "https://api.stepfun.com/step_plan/v1"},
        ), patch(
            "kabuqina_cli.models.fetch_api_models",
...
class TestFetchApiModels:
    ...
    def test_returns_none_on_network_error(self):
        with patch("kabuqina_cli.models.urllib.request.urlopen", side_effect=Exception("timeout")):
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("kabuqina_cli.models.urllib.request.urlopen", side_effect=_fake_urlopen):
...
class TestValidateApiFallback:
    ...
    def test_known_model_accepted_via_catalog_when_api_down(self):
        ...
        with patch(
            "kabuqina_cli.models.provider_model_ids",
    ...
    def test_unknown_provider_soft_accepted_when_api_down(self):
        ...
        with patch("kabuqina_cli.models.provider_model_ids", return_value=[]):
    ...
    def test_custom_endpoint_warns_with_probed_url_and_v1_hint(self):
        with patch(
            "kabuqina_cli.models.probe_api_models",
            return_value={
                "models": None,
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("kabuqina_cli.models.urllib.request.urlopen", return_value=mock_resp):
    ...
    def test_fetch_lmstudio_models_raises_auth_error_on_401(self):
        ...
        with patch("kabuqina_cli.models.urllib.request.urlopen", side_effect=http_error):
    ...
    def test_fetch_lmstudio_models_returns_empty_on_network_error(self):
        with patch(
            "kabuqina_cli.models.urllib.request.urlopen",
...
class TestProbeApiModelsUserAgent:
    ...
    def test_probe_sends_hermes_user_agent(self):
        ...
        assert ua.startswith("kabuqina-cli/"), (
            f"User-Agent must advertise kabuqina-cli, got {ua!r}"
        )
    ...
    def test_probe_user_agent_sent_without_api_key(self):
        ...
        assert ua and ua.startswith("kabuqina-cli/")
