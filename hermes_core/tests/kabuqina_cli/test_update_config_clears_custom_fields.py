"""Tests for kabuqina_cli.auth._update_config_for_provider clearing stale fields.
...
from kabuqina_cli.auth import _update_config_for_provider
from kabuqina_cli.config import get_config_path
