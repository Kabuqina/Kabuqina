"""Tests for kabuqina tools disable/enable/list command (backend)."""
from argparse import Namespace
from unittest.mock import patch

from kabuqina_cli.tools_config import tools_disable_enable_command
...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("kabuqina_cli.tools_config.load_config", return_value=config), \
             patch("kabuqina_cli.tools_config.save_config") as mock_save:
...
class TestToolsDisableMcp:
    ...
    def test_disable_unknown_server_prints_error(self, capsys):
        config = {"mcp_servers": {}}
        with patch("kabuqina_cli.tools_config.load_config", return_value=config), \
             patch("kabuqina_cli.tools_config.save_config"):
            tools_disable_enable_command(
