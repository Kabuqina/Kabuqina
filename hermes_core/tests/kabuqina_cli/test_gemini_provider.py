...
from kabuqina_cli.auth import PROVIDER_REGISTRY, resolve_provider, resolve_api_key_provider_credentials
from kabuqina_cli.models import _PROVIDER_MODELS, _PROVIDER_LABELS, _PROVIDER_ALIASES, normalize_provider
from kabuqina_cli.model_normalize import normalize_model_for_provider, detect_vendor
...
class TestGeminiAgentInit:
    ...
    def test_gemini_agent_uses_chat_completions(self, monkeypatch):
        ...
        with patch("providers.gemini.GeminiNativeClient") as mock_client:
