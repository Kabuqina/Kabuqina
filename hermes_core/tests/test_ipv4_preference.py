...
def _reload_constants():
    """Reload kabuqina_constants to get a fresh apply_ipv4_preference."""
    import kabuqina_constants
    importlib.reload(kabuqina_constants)
    return kabuqina_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_kabuqina_ipv4_patched", False) is True
