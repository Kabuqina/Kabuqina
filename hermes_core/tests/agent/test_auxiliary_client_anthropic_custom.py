"""Tests for providers.chat_completions._try_custom_endpoint's anthropic_messages branch.
...
def test_custom_endpoint_anthropic_messages_builds_anthropic_wrapper():
    ...
    from providers.chat_completions import _try_custom_endpoint, AnthropicAuxiliaryClient

    with patch(
        "providers.chat_completions._resolve_custom_runtime",
        return_value=(
...
def test_custom_endpoint_anthropic_messages_falls_back_when_sdk_missing():
    ...
    from providers.chat_completions import _try_custom_endpoint
    ...
    from providers.chat_completions import AnthropicAuxiliaryClient
