...
class TestResolveAutoMainFirst:
    ...
    def test_openrouter_main_uses_main_model_for_aux(self, monkeypatch):
        ...
        with patch(
            "providers.chat_completions._read_main_provider",
            return_value="openrouter",
        ), patch(
            "providers.chat_completions._read_main_model",
            ...
            from providers.chat_completions import _resolve_auto
    ...
    def test_nous_main_uses_main_model_for_aux(self, monkeypatch):
        ...
        with patch(
            "providers.chat_completions._read_main_provider", return_value="nous",
        ), patch(
            "providers.chat_completions._read_main_model",
    ...
    def test_non_aggregator_main_still_uses_main(self, monkeypatch):
        ...
        with patch(
            "providers.chat_completions._read_main_provider", return_value="deepseek",
        ), patch(
            "providers.chat_completions._read_main_model", return_value="deepseek-chat",
        ), patch(
            "providers.chat_completions.resolve_provider_client"
        ) as mock_resolve:
            mock_client = MagicMock()
    ...
    def test_main_unavailable_falls_through_to_chain(self, monkeypatch):
        ...
        with patch(
            "providers.chat_completions._read_main_provider", return_value="anthropic",
        ), patch(
            "providers.chat_completions._read_main_model", return_value="claude-opus",
        ), patch(
            "providers.chat_completions.resolve_provider_client",
            return_value=(None, None),  # main provider has no client
        ), patch(
            "providers.chat_completions._try_openrouter",
    ...
    def test_no_main_config_uses_chain_directly(self):
        ...
        chain_client = MagicMock()
        with patch(
            "providers.chat_completions._read_main_provider", return_value="",
        ), patch(
            "providers.chat_completions._read_main_model", return_value="",
        ), patch(
            "providers.chat_completions._try_openrouter",
            return_value=(chain_client, "google/gemini-3-flash-preview"),
        ):
    ...
    def test_runtime_override_wins_over_config(self, monkeypatch):
        ...
        with patch(
            ...
            "providers.chat_completions._read_main_model", return_value="config-model",
        ), patch(
            "providers.chat_completions.resolve_provider_client"
        ) as mock_resolve:
...
class TestResolveVisionMainFirst:
    ...
    def test_openrouter_main_vision_uses_main_model(self, monkeypatch):
        ...
        with patch(
            "providers.chat_completions._read_main_provider", return_value="openrouter",
        ), patch(
            "providers.chat_completions._read_main_model",
            return_value="anthropic/claude-sonnet-4.6",
        ), patch(
    ...
    def test_exotic_provider_with_vision_override_preserved(self):
        ...
        with patch(
            "providers.chat_completions._read_main_provider", return_value="xiaomi",
        ), patch(
            "providers.chat_completions._read_main_model",
...
def test_aggregator_providers_constant_removed():
    ...
    """
    import providers.chat_completions as aux_mod
