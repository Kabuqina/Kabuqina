...
class TestMinimaxContextLengths:
    ...
    def test_minimax_prefix_has_correct_context(self):
        from providers.model_metadata import DEFAULT_CONTEXT_LENGTHS
...
class TestMinimaxAuxModel:
    ...
    def test_minimax_aux_is_standard(self):
        from providers.chat_completions import _API_KEY_PROVIDER_AUX_MODELS
...
class TestMinimaxBetaHeaders:
    ...
    def _build_and_get_betas(self, api_key, base_url=None):
        ...
        with patch("providers.anthropic._anthropic_sdk") as mock_sdk:
    ...
    def test_common_betas_none_url(self):
        from providers.anthropic import _common_betas_for_base_url, _COMMON_BETAS
    ...
    def test_common_betas_minimax_url(self):
        from providers.anthropic import _common_betas_for_base_url, _TOOL_STREAMING_BETA
...
class TestMinimaxPreserveDots:
    ...
    def test_normalize_preserves_m25_free_dot(self):
        from providers.anthropic import normalize_model_name
...
class TestMinimaxSwitchModelCredentialGuard:
    ...
    def test_switch_to_minimax_does_not_resolve_anthropic_token(self):
        ...
        with patch("providers.anthropic.build_anthropic_client") as mock_build, \
             patch("providers.anthropic.resolve_anthropic_token", return_value="sk-ant-leaked") as mock_resolve, \
             patch("providers.anthropic._is_oauth_token", return_value=False):
