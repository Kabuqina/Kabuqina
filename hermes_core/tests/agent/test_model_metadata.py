...
class TestDefaultContextLengths:
    ...
    def test_grok_substring_matching(self):
        ...
        with mock_patch("providers.model_metadata.fetch_model_metadata", return_value={}),              mock_patch("providers.model_metadata.fetch_endpoint_model_metadata", return_value={}),              mock_patch("providers.model_metadata.get_cached_context_length", return_value=None):
            cases = [
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        with mock_patch("providers.model_metadata.fetch_model_metadata", return_value={}), \
             mock_patch("providers.model_metadata.fetch_endpoint_model_metadata", return_value={}), \
             mock_patch("providers.model_metadata.get_cached_context_length", return_value=None):
            cases = [
                ("deepseek-v4-pro", 1_000_000),
                ("deepseek-v4-flash", 1_000_000),
...
class TestGetModelContextLength:
    @patch("providers.model_metadata.fetch_model_metadata")
    ...
    def test_cache_takes_priority_over_api(self, mock_fetch, tmp_path):
        ...
        with patch("providers.model_metadata._get_context_cache_path", return_value=cache_file):
    ...
    @patch("providers.model_metadata.fetch_model_metadata")
    @patch("providers.model_metadata.fetch_endpoint_model_metadata")
...
class TestStripProviderPrefix:
    ...
    def test_ollama_model_tag_not_mangled_in_context_lookup(self, mock_fetch):
        ...
        """
        mock_fetch.return_value = {}
        with patch("providers.model_metadata.fetch_endpoint_model_metadata") as mock_ep, \
             patch("providers.model_metadata._is_custom_endpoint", return_value=True):
...
class TestFetchModelMetadata:
    def _reset_cache(self):
        import providers.model_metadata as mm
        mm._model_metadata_cache = {}
        mm._model_metadata_cache_time = 0

    @patch("providers.model_metadata.requests.get")
