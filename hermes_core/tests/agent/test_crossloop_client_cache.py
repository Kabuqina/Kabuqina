...
def _clean_client_cache():
    ...
    with patch.dict("sys.modules", {}):
        pass
    # Import and clear
    import providers.chat_completions as ac
...
class TestCrossLoopCacheIsolation:
    ...
    def test_same_loop_reuses_client(self):
        ...
        from providers.chat_completions import _get_cached_client, _client_cache
    ...
    def test_different_loops_get_different_clients(self):
        ...
        from providers.chat_completions import _get_cached_client
