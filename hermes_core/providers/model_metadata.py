...
from kabuqina_constants import OPENROUTER_MODELS_URL
...
_PROVIDER_PREFIXES: frozenset[str] = frozenset({
    ...
    "glm", "z-ai", "z.ai", "zhipu",
    "kimi", "moonshot", "kimi-cn", "moonshot-cn", "claude", "deep-seek",
    "ollama",
    "stepfun", "dashscope", "aliyun", "qwen",
    "mimo", "xiaomi-mimo",
...
# Minimum context length required to run Kabuqina.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    "gpt-5": 400000,                  # GPT-5.x base and mini variants (400k)
    "gpt-4.1": 1047576,
    "gpt-4": 128000,
    # Google
    "gemini": 1048576,
    ...
    # so these hardcoded fallbacks prevent Kabuqina from probing-down to
...
def fetch_model_metadata(force_refresh: bool = False) -> Dict[str, Dict[str, Any]]:
    ...
    Kabuqina desktop children use the user's configured provider only —
...
def _get_context_cache_path() -> Path:
    ...
    return get_kabuqina_home() / "context_length_cache.yaml"
...
def _model_id_matches(candidate_id: str, lookup_model: str) -> bool:
    ...
    - Slug match:   "anthropic/claude-sonnet-4.6" matches "claude-sonnet-4.6"
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Kabuqina grow conversations past the runtime limit and Ollama
...
def get_model_context_length(
    ...
    # Known providers skip this; models.dev has provider-specific context
    # values and is checked at step 5+.
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Kabuqina sends to providers:
