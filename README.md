...
> 早期版本有过第三个入口 REPORT（把材料做成 PPT/文档）。它已从产品中砍掉——那类"生成交付物"
> 的活通用 agent 都能做，不是这款学习 agent 不可替代的价值。产品聚焦 Study。
...
| 消息入口 | 微信、QQ、钉钉，或 Telegram、WhatsApp、Email 等按产品版本提供的适配器，用于提醒和投递 | 已接入 |
