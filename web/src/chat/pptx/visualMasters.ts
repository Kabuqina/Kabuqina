...
export const PPT_VISUAL_MASTERS = [
  {
    ...
    typography: {
      coverTitle: { fontFace: "Microsoft YaHei UI", fontSize: 40, bold: true, color: "title" },
      title: { fontFace: "Microsoft YaHei UI", fontSize: 26, bold: true, color: "title" },
      subtitle: { fontFace: "Microsoft YaHei UI", fontSize: 14, bold: true, color: "accent" },
      kicker: { fontFace: "Microsoft YaHei UI", fontSize: 11, bold: true, color: "accent", charSpacing: 2 },
      body: { fontFace: "Microsoft YaHei UI", fontSize: 18, color: "body" },
  ...
  },
  {
    ...
    typography: {
      coverTitle: { fontFace: "Microsoft YaHei UI", fontSize: 42, bold: true, color: "title" },
      title: { fontFace: "Microsoft YaHei UI", fontSize: 28, bold: true, color: "title" },
      subtitle: { fontFace: "Microsoft YaHei UI", fontSize: 13, bold: true, color: "accent" },
      kicker: { fontFace: "Microsoft YaHei UI", fontSize: 10, bold: true, color: "accent", charSpacing: 2 },
      body: { fontFace: "Microsoft YaHei UI", fontSize: 17, color: "body" },
  ...
  },
  {
    ...
    typography: {
      coverTitle: { fontFace: "Microsoft YaHei UI", fontSize: 38, bold: true, color: "title" },
      title: { fontFace: "Microsoft YaHei UI", fontSize: 25, bold: true, color: "title" },
      subtitle: { fontFace: "Microsoft YaHei UI", fontSize: 13, color: "accent2" },
      kicker: { fontFace: "Microsoft YaHei UI", fontSize: 10, bold: true, color: "accent", charSpacing: 2 },
      body: { fontFace: "Microsoft YaHei UI", fontSize: 17, color: "body" },
  ...
  },
  {
    ...
    typography: {
      coverTitle: { fontFace: "Microsoft YaHei UI", fontSize: 39, bold: true, color: "title" },
      title: { fontFace: "Microsoft YaHei UI", fontSize: 24, bold: true, color: "title" },
      subtitle: { fontFace: "Microsoft YaHei UI", fontSize: 12, bold: true, color: "body" },
      kicker: { fontFace: "Microsoft YaHei UI", fontSize: 10, bold: true, color: "title", charSpacing: 2 },
      body: { fontFace: "Microsoft YaHei UI", fontSize: 16, color: "body" },
      caption: { fontFace: "Microsoft YaHei UI", fontSize: 10, color: "body" },
    },
  ...
  },
  {
    ...
    typography: {
      coverTitle: { fontFace: "Microsoft YaHei UI", fontSize: 40, bold: true, color: "title" },
      title: { fontFace: "Microsoft YaHei UI", fontSize: 27, bold: true, color: "title" },
      subtitle: { fontFace: "Microsoft YaHei UI", fontSize: 14, color: "body" },
      kicker: { fontFace: "Microsoft YaHei UI", fontSize: 11, bold: true, color: "accent2", charSpacing: 1 },
      body: { fontFace: "Microsoft YaHei UI", fontSize: 18, color: "body" },
      caption: { fontFace: "Microsoft YaHei UI", fontSize: 10, italic: true, color: "body" },
    },
